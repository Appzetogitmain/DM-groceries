...
const SlideToPay = ({
    ...
    return (
        <div
            className="relative h-16 w-full rounded-full overflow-hidden select-none touch-none bg-linear-to-r from-[#1A4516] via-[#1A4516] to-[#1A4516] shadow-[0_18px_45px_rgba(4,120,87,0.35)] border border-white/10"

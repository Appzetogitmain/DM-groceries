      ...
      {show && (
        <motion.div
          ...
          <motion.div
            ...
            className="w-24 h-24 bg-[#E6F3E6] rounded-full flex items-center justify-center text-[#1A4516] mb-6">
          ...
          <motion.div
            ...
            className="w-48 h-1.5 bg-[#E6F3E6] rounded-full overflow-hidden">
            <div className="h-full bg-[#1A4516]" />
          </motion.div>
        </motion.div>
      )}
    </AnimatePresence>

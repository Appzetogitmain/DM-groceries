            ...
            <div className="p-5 max-w-3xl mx-auto space-y-6">
                <div className="bg-white rounded-3xl p-6 shadow-sm border border-slate-100">
                    <div className="flex items-center gap-4 mb-6">
                        ...
                        <div>
                            <h2 className="text-xl font-bold text-slate-800">Privacy Policy (Delivery Partner)</h2>
                        </div>
                    </div>
                    ...
                    <div className="prose prose-slate prose-sm max-w-none text-slate-600 space-y-4">
                        <div className="markdown-body text-sm text-slate-600 space-y-4">
                            {settings?.deliveryPrivacyPolicy ? (
                                ...
                                <p>Your privacy is important to us. This privacy policy explains how we collect and use your data for delivery partners.</p>
                            )}
                        </div>
                    </div>
                </div>

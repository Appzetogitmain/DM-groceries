        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-3">
            <div className="relative">
              <div className="h-10 w-10 bg-[#1A4516] rounded-full flex items-center justify-center text-white font-black text-sm shadow-sm ring-2 ring-white overflow-hidden">
              ...
              <div className="absolute bottom-0 right-0 h-3 w-3 bg-[#1A4516] rounded-full border-2 border-white animate-pulse"></div>
            </div>
            <div>
              <h1 className="text-base font-black text-slate-800 leading-none">
                Support Chat
              </h1>
              <p className="text-[10px] text-[#1A4516] font-bold mt-1 uppercase tracking-wider flex items-center gap-1">
                <span className="h-1 w-1 bg-[#1A4516] rounded-full"></span>
                Online
              </p>
            </div>
          </div>
            ...
            >
              <div
                className={`px-4 py-3 rounded-2xl shadow-sm border text-sm leading-relaxed ${
                  msg.sender === "user"
                    ? "bg-[#1A4516] text-white border-black/25 rounded-tr-none"
        ...
        <div className="flex items-end gap-2 bg-slate-50 p-2 rounded-[1.5rem] border-2 border-slate-800/70 focus-within:border-slate-900 focus-within:shadow-[0_0_0_4px_rgba(15,23,42,0.08)] transition-all">
          <button
            ...
            className={`p-2.5 rounded-full hover:text-slate-600 hover:bg-slate-200 transition-colors flex-shrink-0 ${
              showEmojiPicker ? "text-[#1A4516] bg-[#1A4516]/10" : "text-slate-400"
            }`}
          >
            <Smile size={22} />
          </button>
          ...
          <button
            ...
            className="p-2.5 rounded-full bg-[#1A4516] text-white hover:bg-[#123010] transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-md shadow-black/20 flex-shrink-0"
          >
